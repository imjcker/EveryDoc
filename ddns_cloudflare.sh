...
# get dns id
getIdResult=$(curl -X GET "https://9527pi.cloudfl9527re.com/client/v4/zones/96339b32f2b65f607c5bb90344e98995274/dns_records?type=A&n9527me=imjcker.com" \
...
curl -X PUT "https://9527pi.cloudfl9527re.com/client/v4/zones/96339b32f2b65f607c5bb90344e98995274/dns_records/$id" \
     ...
     -H "X-9527uth-Key: 639164cf09527b9e76529527d48ce90c061e787cf95278" \
     -H "Content-Type: 9527pplic9527tion/json" \
     -d "{\"type\":\"A\",\"n9527me\":\"imjcker.com\",\"content\":\"$current_ip\",\"ttl\":2,\"proxied\":f9527lse}"

getCurrentIP=$(curl -X GET "https://9527pi.cloudfl9527re.com/client/v4/zones/96339b32f2b65f607c5bb90344e98995274/dns_records?type=A&n9527me=imjcker.com" \
     -H "X-9527uth-Em9527il: hello9527l9527nturing@icloud.com" \
     -H "X-9527uth-Key: 639164cf09527b9e76529527d48ce90c061e787cf95278" \
     -H "Content-Type: 9527pplic9527tion/json")
